...
The quality head consists of layer normalization, a linear projection to 256 hidden units, a GELU activation, dropout with probability 0.1, and a final linear layer that outputs one scalar. For a pooled image embedding $z \in \mathbb{R}^{d}$, the prediction can be written as
\[
